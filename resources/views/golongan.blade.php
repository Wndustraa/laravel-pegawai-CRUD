...
<body>
  ...
  <div class="sidebar">
    ...
    <ul>
      ...
      <li><a href="#" class="active"><i class="fas fa-star"></i> <span>Golongan</span></a></li>
    ...
    <div class="container">
        ...
        <div class="modal-content">
          ...
          <form method="POST" action="/golongan/storetambah">
            ...
            <div class="modal-body">
              ...
              <input type="number" name="tunjangan_transport" placeholder="Contoh: 200000">
              <label>Tunjangan Makan:</label>
              <input type="number" name="tunjangan_makan" placeholder="Contoh: 300000">
            </div>
      ...
      <div id="hapusModal" class="modal">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p>Apakah Anda yakin ingin menghapus data golongan ini? Tindakan ini tidak bisa dibatalkan.</p>
          </div>
          <div class="modal-footer">
        ...
        <table>
          ...
          @foreach ($golongan as $g)
            <tr>
              ...
              <td>Rp {{ number_format($g->tunjangan_keluarga, 0, ',', '.') }}</td>
              <td>Rp {{ number_format($g->tunjangan_transport, 0, ',', '.') }}</td>
              <td>Rp {{ number_format($g->tunjangan_makan, 0, ',', '.') }}</td>
              <td>
    ...
    <div class="modal-content">
      ...
      <form id="editForm" method="POST">
        ...
        <div class="modal-body">
          ...
          <label>Gaji Pokok:</label>
          <input type="number" name="gaji_pokok" id="edit-gaji_pokok" required>
          <label>Tunjangan Keluarga:</label>
          <input type="number" name="tunjangan_keluarga" id="edit-tunjangan_keluarga">
          <label>Tunjangan Transport:</label>
          <input type="number" name="tunjangan_transport" id="edit-tunjangan_transport">
          <label>Tunjangan Makan:</label>
          <input type="number" name="tunjangan_makan" id="edit-tunjangan_makan">
        </div>
        <div class="modal-footer">
  ...
  <script>
    ...
    function openEditModal(id, nama, gaji_pokok, tunjangan_keluarga, tunjangan_transport, tunjangan_makan) {
      document.getElementById('edit-id').value = id;
      document.getElementById('edit-nama').value = nama;
      document.getElementById('edit-gaji_pokok').value = gaji_pokok || 0;
      document.getElementById('edit-tunjangan_keluarga').value = tunjangan_keluarga || 0;
      document.getElementById('edit-tunjangan_transport').value = tunjangan_transport || 0;
      document.getElementById('edit-tunjangan_makan').value = tunjangan_makan || 0;
      document.getElementById('editForm').action = `/golongan/update/${id}`;
