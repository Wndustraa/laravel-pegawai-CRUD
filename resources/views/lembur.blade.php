...
<body>
  ...
  <div class="sidebar">
    ...
    <ul>
      ...
      <li><a href="#" class="active"><i class="fas fa-clock"></i> <span>Lembur</span></a></li>
    </ul>
  </div>
    ...
    <div class="container">
        ...
        <div class="modal-content">
          ...
          <form method="POST" action="/lembur/storetambah">
            ...
            <div class="modal-body">
              ...
              <label>Total Uang Lembur (Rp):</label>
      ...
      <div id="hapusModal" class="modal">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p>Apakah Anda yakin ingin menghapus data lembur ini? Tindakan ini tidak bisa dibatalkan.</p>
          </div>
          <div class="modal-footer">
      ...
      <div class="table-container">
        <table>
          ...
          @foreach ($lembur as $l)
            <tr>
              <td>{{ $l->id }}</td>
              <td>{{ $l->pegawai_nama }}</td>
              <td>{{ $l->bulan_lembur }}</td>
              <td>{{ $l->jumlah_lembur }} jam</td>
              <td><strong>Rp {{ number_format($l->total_uang_lembur, 0, ',', '.') }}</strong></td>
              <td>
...
<div id="editModal" class="modal">
  <div class="modal-content">
    ...
    <form id="editForm" method="POST">
      ...
      <div class="modal-body">
        ...
        <label>Pegawai:</label>
        <input type="text" name="pegawai_nama" id="edit-pegawai_nama"  required>

        <label>Bulan Lembur:</label>
        <input type="text" name="bulan_lembur" id="edit-bulan_lembur" required>

        <label>Jumlah Jam Lembur:</label>
        <input type="number" name="jumlah_lembur" id="edit-jumlah_lembur" required>

        <label>Total Uang Lembur (Rp):</label>
        <input type="number" name="total_uang_lembur" id="edit-total_uang_lembur" required>
      </div>
      <div class="modal-footer">
  ...
  <script>
    ...
    function openEditModal(id, pegawai_id,pegawai_nama, bulan_lembur, jumlah_lembur, total_uang_lembur) {
      ...
      document.getElementById('edit-bulan_lembur').value = bulan_lembur;
      document.getElementById('edit-jumlah_lembur').value = jumlah_lembur || 0;
      document.getElementById('edit-total_uang_lembur').value = total_uang_lembur || 0;
      document.getElementById('editForm').action = `/lembur/update/${id}`;
